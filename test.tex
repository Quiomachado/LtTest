...
\begin{itemize}
    \item \textbf{Q13:} $w_0 = \frac{2\pi}{T} = \frac{2\pi}{0.4} = 5\pi$\hspace{50px}$T = 0.4$
          \[a_0 = \frac{1}{T}\int_{T}x(t)dt = \frac{1}{0.4} \times 0.3 = \frac{3}{4} = 0.75\hspace{15px} \vspace{10px}\]
...
\begin{itemize}
    ...
    \item \textbf{Q28:}
          ...
          \end{figure}
          \newpage
    \item \textbf{Q29:} O sinal $yc1$ é uma reconstrução de período $0.01$ de uma amostragem de mesmo periodo do sinal $xc1$.
          \begin{figure}[!ht]
